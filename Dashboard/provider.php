  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="provider.php"><img src="images/6ilrpjqsny80b5ti.png" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="provider.php"><img src="images/favicon.ico" alt="logo"/></a>
      </div>
